                ...
                <div class="header__wrapper">
                    ...
                    <div class="header__actions">
                        <div class="header__progress">
                            <p class="header__progress--txt">Tiến độ: &emsp;<span class="progress_learned">2</span>/<span class="progress_lesson">8</span></p>
                            <div class="progress">
                        ...
                        <div class="header__cert">
                            ...
                            <a class="header__cert--link" href="<?= $GLOBALS["domainPage"] ?>/certificate/notFnLearn?idCourse=<?= $id_course ?>">
                ...
                <div class="learning__wrapper">
                    <div class="learning__video">
                        ...
                        <div class="comment__wrapper">
                            ...
                            <div class="noteZone">
                                <form class="noteForm" action="<?= $GLOBALS["domainPage"] ?>/learning/AddNewNote" method="POST">
                                    ...
                                    <div class="form__group">
                                        ...
                                        <textarea required placeholder="Nội dung ghi chú..." class="note--ipt" name="note_content" id="" cols="30" rows="10"></textarea>
                                    </div>
