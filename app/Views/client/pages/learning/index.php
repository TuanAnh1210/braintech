...
<head>
    ...
    <link rel="stylesheet" href="<?= $GLOBALS['domainPage'] ?>/public/css/learning.css">
</head>
            ...
            <div class="container-fluid">
                <div class="learning__wrapper">
                    <div class="learning__video">
                        <iframe class="video--link" src="https://www.youtube.com/embed/x0fSBAgBrOQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
                    <div class="learning__bar">
                        ...
                        <div class="learning__chapter">
                            ...
                            <div class="trackItem">
                                <h3 class="trackItem--title">1. ReactJS là gì? Tại sao nên học ReactJS? <span style="color: #5db85c;">
