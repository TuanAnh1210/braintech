...
<!--   Core JS Files   -->
<script src="<?= $GLOBALS["domainPage"] ?>/public/js/admin/core/jquery.min.js"></script>
<script src="<?= $GLOBALS["domainPage"] ?>/public/js/admin/core/popper.min.js"></script>
<script src="<?= $GLOBALS["domainPage"] ?>/public/js/admin/core/bootstrap-material-design.min.js"></script>
...
<!-- Chartist JS -->
<script src="<?= $GLOBALS["domainPage"] ?>/public/js/admin/plugins/chartist.min.js"></script>
<!--  Notifications Plugin    -->
<script src="<?= $GLOBALS["domainPage"] ?>/public/js/admin/plugins/bootstrap-notify.js"></script>
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->
<script src="<?= $GLOBALS["domainPage"] ?>/public/js/admin/material-dashboards.js?v=2.1.0"></script>
<!-- Material Dashboard DEMO methods, don't include it in your project! -->
<script src="<?= $GLOBALS["domainPage"] ?>/public/js/admin/demo.js"></script>
<script>
