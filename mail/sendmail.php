...
try {
    ...
    $mail->Username = 'braintech1210085213@gmail.com'; // SMTP username
    $mail->Password = 'ubfcxsujzgiglijd'; // SMTP password
    $mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587; // TCP port to connect to

    //Recipients
    $mail->setFrom('braintech1210085213@gmail.com', 'BrainTech');
...
<body>
    <div class="form__wrapper">
        <form class="authForm" action="<?= $GLOBALS["domainPage"] ?>/account/authSuccess" method="POST">
            ...
            <input hidden type="text" value="<?= $arrInfo['name'] ?>" name="fullnameUser">
            ...
            <input hidden type="text" value="<?= $arrInfo['date_join'] ?>" name="date_joinUser">
